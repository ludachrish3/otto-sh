...
| `embedded` | `os_type: embedded` | `refused` | `refused` | `refused` | `refused` | yes | none | `console` and `tftp` | A serial console has no user to switch to, and transfer ownership follows the connection's own identity. |
| `zephyr` | `os_type: zephyr` | `refused` | `refused` | `refused` | `refused` | yes | none | `console` and `tftp` | A serial console has no user to switch to, and transfer ownership follows the connection's own identity. |
