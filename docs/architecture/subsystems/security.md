...
with no backend at all — see [Web dashboard](../../cli/monitor/dashboard.md#web-dashboard)),
...
See [Securing the dashboard](../../cli/monitor/serving.md#serving-the-dashboard)
