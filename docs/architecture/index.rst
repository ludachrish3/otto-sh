...
Start with the overview, the shared command lifecycle, startup performance
on network filesystems, the test strategy, and the quality gates that
enforce all of it, then jump to the area you are changing. The extensibility
pages
