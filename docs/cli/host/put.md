...
| `--user NAME` | none | Transfer as this owner. What each host family does with it — authenticate as them, chown after the fact, ignore it, or refuse — is declared per family in {doc}`families` |
