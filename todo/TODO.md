...
- Remove path tab complete
  - otto host <id> put/get currently tab complete using local paths for source and dest locations. Look into ways to tab complete for remote paths. SSH can for sure be used for this, but what about for telnet hosts?
