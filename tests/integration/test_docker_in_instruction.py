...
from src.otto.docker import build_images, composed
...
async def test_instruction_uses_composed_context_manager(parent_lab):
    ...
    assert "pepper_seed.repo1.api" not in lab.hosts
